...
class youdao():
    ...
    #def playword(self,content):
        
        #c=str('Speech_EN\\'+content+'.mp3')
        #c=str.encode(c,encoding='utf-8')
        #d=self.down(content)
        #playsound(self.down(content))
        #playsound(c)
...
if __name__ == "__main__":
    ...
    #winsound.PlaySound(sp.down('helloworld'),) 
    #sp.playword('this')
    #playsound('Speech_EN\\reconcile.mp3')
#playsound(sp.down('helloworld'))
